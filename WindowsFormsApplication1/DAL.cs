...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection("Data Source=(LocalDB)\\v11.0;AttachDbFilename="+System.Windows.Forms.Application.StartupPath+"\\login.mdf;Integrated Security=True;Connect Timeout=30");
        }
